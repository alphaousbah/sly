...
Revision ID: 622040702940
Revises: 
Create Date: 2023-10-08 20:17:55.206374
...
def upgrade():
    ...
    sa.Column('histolossfile_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['histolossfile_id'], ['histolossfile.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('selectedpricingrelationship',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=50), nullable=True),
    sa.Column('layer_id', sa.Integer(), nullable=True),
    sa.Column('modelfile_id', sa.Integer(), nullable=True),
...
def downgrade():
    ...
    op.drop_table('selectedpricingrelationship')
